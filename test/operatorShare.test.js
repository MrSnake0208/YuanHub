...
test('分享页概览使用 v2 只读卡片，不提供点击详情弹窗', () => {
  ...
  assert.match(ledgerV2Styles, /\.agent-ledger-card--share\.agent-ledger-card--v2 \.ledger-combat-stat \{[\s\S]*?grid-template-columns: minmax\(0, 1fr\) 14px max-content minmax\(0, 1fr\);[\s\S]*?column-gap: 8px;[\s\S]*?padding: 4px 2px 8px;/)
